...
<head>
    ...
    <title>Editar Reseña - <?= $libro->titulo ?> - SanabriaCod</title>
...
<body class="bg-light">
            ...
            <div class="col-lg-8">
                <div class="form-container">
                    ...
                    <div class="text-center mb-4">
                        <h2><i class="fas fa-edit text-warning me-2"></i>Editar Reseña</h2>
                        <p class="text-muted">Modifica tu opinión sobre este libro</p>
                    </div>

                    <?= form_open('resenas/actualizar', ['class' => 'needs-validation', 'novalidate' => '']) ?>
                        <input type="hidden" name="resena_id" value="<?= $resena->id ?>">
                        
                        <!-- Sistema de Calificación -->
                        <div class="rating-container">
                            <label class="form-label fw-bold">Tu Calificación:</label>
                            <div class="stars" data-rating="<?= $resena->calificacion ?>">
                            ...
                            <div class="rating-text" id="rating-text">Calificación actual: <?= $resena->calificacion ?> estrellas</div>
                            <input type="hidden" name="calificacion" id="calificacion-input" value="<?= $resena->calificacion ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   maxlength="100"
                                   required>
                            <div class="character-count" id="titulo-count"><?= strlen($resena->titulo) ?>/100</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="character-count" id="comentario-count"><?= strlen($resena->comentario) ?>/1000</div>
                            <div class="invalid-feedback">
    ...
    <script>
        ...
        // Inicializar estrellas con la calificación actual
        highlightStars(<?= $resena->calificacion ?>);
        ...
        document.querySelector('.stars').addEventListener('mouseleave', function() {
            ...
            ratingText.textContent = `Calificación actual: ${currentRating} estrellas`;
        });
        
        function setRating(value) {
            calificacionInput.value = value;
            highlightStars(value);
            ratingText.textContent = `Calificación actual: ${value} estrellas`;
        }
